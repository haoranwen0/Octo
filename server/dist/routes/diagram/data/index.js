...
exports.gptDiagramJSONFn = exports.gptDiagramInst = void 0;
...
exports.gptDiagramInst = gptDiagramInst;
const gptDiagramJSONFn = {
    name: 'design_system',
    description: 'System design function that takes in an array of the components that make up the system.',
    parameters: {
        type: 'object',
        properties: {
            components: {
                type: 'array',
                description: "An array of the components that make up the system design. Each component has a children property, which is also an array of the names of the component's children. Each component must have at least one child or must be a parent",
                items: {
                    type: 'object',
                    properties: {
                        ...
                        children: {
                            type: 'array',
                            description: 'An array of the names of the children components that the parent component connects to',
                            items: {
                                type: 'string',
            ...
            description: {
                type: 'string',
                description: 'A description on the system as a whole. What each component is responsible for. Why they are important, and how they are connected with each other.'
            }
        },
        dependencies: {
            components: {
...
exports.gptDiagramJSONFn = gptDiagramJSONFn;
